...
public class PILLDocument implements Document<Component> {
	...
	/**
	 * Registry to register new Styles and to make them parse-able
	 */
	private StyleRegistry styleReg = new StyleRegistry();
	/**
	...
	public StyleRegistry styleRegisty() {
		return this.styleReg;
	}
